           ...
           <div className="max-w-3xl mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5">
              ...
              <Button 
                ...
                className="bg-gradient-to-br from-[#2F7F8F] to-[#246670] text-white font-semibold text-base sm:text-lg px-4 sm:px-8 py-5 sm:py-6 rounded-full shadow-[0_6px_16px_rgba(0,0,0,0.12)] hover:-translate-y-0.5 hover:brightness-110 transition-all duration-200 w-full border-0"
              >
              ...
              <Button 
                ...
                className="bg-gradient-to-br from-[#2C6E9B] to-[#215577] text-white font-semibold text-base sm:text-lg px-4 sm:px-8 py-5 sm:py-6 rounded-full shadow-[0_6px_16px_rgba(0,0,0,0.12)] hover:-translate-y-0.5 hover:brightness-110 transition-all duration-200 w-full border-0"
              >
