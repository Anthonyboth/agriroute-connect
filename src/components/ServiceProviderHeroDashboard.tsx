  ...
  useEffect(() => {
    ...
    const channel = supabase
      ...
      .on('postgres_changes', {
        ...
        if (import.meta.env.DEV) console.log('[HeroDashboard] service_requests changed — refreshing stats');
        fetchStats();
      })
      .subscribe();
