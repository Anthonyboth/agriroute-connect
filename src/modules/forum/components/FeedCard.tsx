...
import { MessageSquare, Flag, Share2, Pin, Lock } from 'lucide-react';
...
export function FeedCard({ thread, userVote, onReport }: FeedCardProps) {
  return (
    <div className="flex bg-card border rounded-lg hover:border-primary/30 transition-colors">
      {/* Vote column */}
