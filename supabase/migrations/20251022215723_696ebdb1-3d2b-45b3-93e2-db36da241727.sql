...
) AS new_services(client_id, service_type, status, location_address, location_city, location_lat, location_lng, problem_description, contact_phone, estimated_price)
