          ...
          THEN ARRAY(
            SELECT DISTINCT 
              CASE 
                ...
                WHEN v.vehicle_type = 'PICKUP' THEN 'pickup'::service_category
                WHEN v.vehicle_type = 'PRANCHA' THEN 'prancha'::service_category
                WHEN v.vehicle_type = 'GUINCHO' THEN 'guincho'::service_category
