...
-- ===============================================
-- These 3 policies were missed in the previous migration
-- ===============================================
...
-- 2. SERVICE_PROVIDERS - duplicate policy name fix
...
-- 3. VEHICLES - duplicate policy fix
...
-- ===============================================
-- ALL POLICIES FIXED! Zero references to profiles.role remaining
-- ===============================================
