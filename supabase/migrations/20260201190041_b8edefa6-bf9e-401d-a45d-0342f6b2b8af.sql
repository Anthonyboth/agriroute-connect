...
-- =====================================================
-- CORRIGIR a função auto_cancel_overdue_freights
-- DROP primeiro por causa da mudança de tipo de retorno
-- =====================================================
...
BEGIN
  ...
  -- (Previne erros como o que aconteceu)
  -- =========================================================
  ...
  LOOP
    -- Se a contagem real difere da registrada, corrigir
