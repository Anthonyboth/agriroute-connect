-- Fix ambiguous column reference in cancel_accepted_service
...
COMMENT ON FUNCTION public.cancel_accepted_service IS 'Allows service providers to cancel accepted services and return them to marketplace - Fixed ambiguous ID reference';