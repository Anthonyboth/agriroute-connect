-- Fix: Tratar sufixo _URB na RPC get_services_for_provider
-- O prestador com CARREGAMENTO_DESCARREGAMENTO deve ver CARREGAMENTO_DESCARREGAMENTO_URB
...
BEGIN
  ...
  -- Normalizar tipos do prestador removendo sufixo _URB para matching flexível
  ...
  WHERE sr.status = 'OPEN'
    ...
    -- Match por tipo: normalizar ambos removendo _URB
    AND (
