...
const UpdateFreightSchema = z.object({
  ...
  updates: z.object({
    ...
    price: z.union([z.number().min(0).max(10000000), z.null()]).optional(),
    price_per_km: z.union([z.number().min(0).max(10000000), z.null()]).optional(),
    pricing_type: z.enum(['FIXED', 'PER_KM', 'PER_TON']).optional(),
    cargo_type: z.string().max(100).optional(),
    weight: z.union([z.number().min(0).max(1000000000), z.null()]).optional(),
    origin_address: z.string().max(500).optional(),
    origin_lat: z.union([z.number(), z.null()]).optional(),
    origin_lng: z.union([z.number(), z.null()]).optional(),
    destination_address: z.string().max(500).optional(),
    destination_lat: z.union([z.number(), z.null()]).optional(),
    destination_lng: z.union([z.number(), z.null()]).optional(),
    urgency: z.enum(['LOW', 'MEDIUM', 'HIGH']).optional(),
    required_trucks: z.number().int().min(1).max(100).optional(),
    minimum_antt_price: z.union([z.number().min(0), z.null()]).optional(),
